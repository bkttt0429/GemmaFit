...
| Artifact | Path |
| --- | --- |
| Report video | `docs/assets/video/gemmafit_architecture_motionzip_real_report_en.mp4` |
| Thumbnail | `docs/assets/video/gemmafit_architecture_motionzip_real_report_thumb_en.jpg` |
| Contact sheet | `docs/assets/video/gemmafit_architecture_motionzip_real_report_contact_sheet_en.jpg` |
| Vision scene anchor | `docs/benchmark/architecture_report_video_real_2026-05-17/vision_scene_anchor_en.jpg` |
| Vision MotionZip panel | `docs/benchmark/architecture_report_video_real_2026-05-17/vision_motionzip_panel_en.jpg` |
...
| Summary JSON | `docs/benchmark/architecture_report_video_real_2026-05-17/report_video_summary_en.json` |
...
| Image | Purpose | Path |
| --- | --- | --- |
| 1. Scene anchor | environment, support object, person visibility | `docs/benchmark/architecture_report_video_real_2026-05-17/vision_scene_anchor_en.jpg` |
| 2. MotionZip panel | selected motion windows plus compact deterministic facts | `docs/benchmark/architecture_report_video_real_2026-05-17/vision_motionzip_panel_en.jpg` |
...
python docs\assets\video_sources\generate_architecture_motionzip_real_video.py --lang en
```
